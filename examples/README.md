...
These are illustrative artifacts, not real user data. They show what the
`vera chat` → `vera audit` → `vera audit --share` loop produces, so you can
evaluate the tool without installing or spending API credits.
